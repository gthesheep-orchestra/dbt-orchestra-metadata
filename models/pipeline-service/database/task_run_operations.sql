...
/*
  ...
  Description: This model aggregates task runs and operations, providing detailed metrics such as duration, status, and cost, while allowing for pagination and filtering based on various parameters.
*/
